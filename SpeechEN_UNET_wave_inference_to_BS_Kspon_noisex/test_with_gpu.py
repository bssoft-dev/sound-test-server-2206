...
if __name__ == '__main__':
    ...
    parser.add_argument('--InSample_PATH',     default = './in_samples/test.mp3',  type=str,  dest='InSample_PATH')
    parser.add_argument('--OutSample_PATH',    default = './out_samples/out.wav',  type=str,  dest='OutSample_PATH')
