...
def get_jwt_strategy() -> JWTStrategy:
    return JWTStrategy(secret=SECRET, lifetime_seconds=3600*24*365*10)
...
current_hyper_user = fastapi_users.current_user(active=True, superuser=True, hyperuser=True)