...
class BearerResponse(BaseModel):
    ...
    is_hyperuser: Optional[bool] = None
...
class BearerTransport(Transport):
    ...
    async def get_login_response(self, token: str, response: Response, picture: Optional[str] = None, isHyperUser: Optional[bool] = None) -> Any:
        return BearerResponse(access_token=token, token_type="bearer", picture=picture, is_hyperuser=isHyperUser)

    # async def get_login_response(self, token: str, response: Response, customerCode: Optional[str]=None, 
    #     picture: Optional[str] = None, isHyperUser: Optional[bool] = None) -> Any:
    #     return BearerResponse(access_token=token, token_type="bearer", customer_code=customerCode, picture=picture, is_hyperuser=isHyperUser)
                ...
                "content": {
                    "application/json": {
                        "example": {
                            ...
                            "token_type": "bearer",
                            "customerCode": "bssoft",
                            "picture": "http://blabla.com/mypicture.png",
                            "is_hyperuser": False
                        }
                    }
                },
